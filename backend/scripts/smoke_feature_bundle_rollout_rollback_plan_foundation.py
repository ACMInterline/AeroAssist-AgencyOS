...
MINIMUM_PHASE = "phase_40_12_feature_bundle_rollout_rollback_plan_foundation"
...
def verify_frontend_and_docs() -> None:
    for path, text in [
        ...
        (ROOT / "frontend/src/routes/RoutedApplication.jsx", "/platform/feature-bundle-rollout-rollback-plans"),
        (ROOT / "frontend/src/routes/RoutedApplication.jsx", "/agency/rollout-rollback-plans"),
