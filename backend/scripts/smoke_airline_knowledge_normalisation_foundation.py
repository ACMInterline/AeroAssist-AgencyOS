...
MINIMUM_PHASE = "phase_50_3_airline_knowledge_normalisation_foundation"
...
def verify_frontend_and_docs() -> None:
    for path, text in [
        (ROOT / "frontend/src/routes/RoutedApplication.jsx", "/platform/airline-knowledge-normalisation"),
        (ROOT / "frontend/src/routes/RoutedApplication.jsx", "/agency/knowledge-normalisation"),
