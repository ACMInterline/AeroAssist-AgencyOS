...
def main() -> int:
    ...
    if "Phase 50.1" not in gaps.get("next_immediate_phase", ""):
    ...
    if not next_phases.get("items") or next_phases["items"][0].get("phase") != "Phase 50.1":
        raise AssertionError("Next phase recommendations did not start with Phase 50.1.")
