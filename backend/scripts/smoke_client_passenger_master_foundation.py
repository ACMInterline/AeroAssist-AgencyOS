...
def verify_router_ui_docs_registration() -> None:
    ...
    for path, text in [
        ...
        (ROOT / "frontend/src/components/ClientPassengerMasterRecordList.jsx", "Travel Support Profile"),
        (ROOT / "frontend/src/components/ClientPassengerMasterRecordList.jsx", "Travel Preferences"),
        (ROOT / "frontend/src/components/ClientPassengerMasterRecordList.jsx", "Portal Access"),
        (ROOT / "frontend/src/components/ClientPassengerMasterRecordList.jsx", "Related Records"),
