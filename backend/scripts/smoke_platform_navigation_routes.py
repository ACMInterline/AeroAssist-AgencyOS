...
EXPECTED_PHASE = "phase_36_4_ticket_emd_foundation"
...
def main() -> int:
    ...
    require_text(layout, ["Summary", "Agencies", "Reference Data", "Airlines / Knowledge", 'href="/platform/agencies"', 'href="/platform/airlines"'], "Platform header")
