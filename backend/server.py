...
from services.journey_comparison_client_presentation_service import PHASE_LABEL, JourneyComparisonClientPresentationService
...
app = FastAPI(
    ...
    version="0.1.0",
    description="AeroAssist AgencyOS API foundation through Phase 56.3 journey comparison and client presentation foundation.",
)
