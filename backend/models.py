...
class AirlineKnowledgeNormalisation(BaseDocument):
    agency_id: Optional[str] = None
    normalisation_reference: str
    normalisation_status: str = "draft"
    ...
    taxonomy_variant: Optional[str] = None
    parent_canonical_id: Optional[str] = None
    hierarchy_path: List[str] = Field(default_factory=list)
    hierarchy_level: Optional[int] = None
    aliases: List[str] = Field(default_factory=list)
    abbreviations: List[str] = Field(default_factory=list)
    airline_specific_terms: List[str] = Field(default_factory=list)
    gds_terms: List[str] = Field(default_factory=list)
    ...
    ssr_codes: List[str] = Field(default_factory=list)
    rfic_codes: List[str] = Field(default_factory=list)
    rfisc_codes: List[str] = Field(default_factory=list)
    species: Optional[str] = None
    breed: Optional[str] = None
    breed_group: Optional[str] = None
    brachycephalic_flag: bool = False
    restricted_breed_flag: bool = False
    service_animal_flag: bool = False
    emotional_support_animal_flag: bool = False
    animal_notes: Optional[str] = None
    aircraft_family: Optional[str] = None
    aircraft_subtype: Optional[str] = None
    cabin_family: Optional[str] = None
    cabin_name: Optional[str] = None
    seat_type: Optional[str] = None
    fixed_armrest_flag: bool = False
    adjacent_seat_relevance: Optional[str] = None
    under_seat_space_relevance: Optional[str] = None
    cabin_notes: Optional[str] = None
    passenger_need_category: Optional[str] = None
    service_domain: Optional[str] = None
    service_family: Optional[str] = None
    service_variant: Optional[str] = None
    related_ssr_code: Optional[str] = None
    related_osi_relevance: Optional[str] = None
    related_emd_relevance: Optional[str] = None
    related_document_relevance: Optional[str] = None
    ...
    pricing_reference_ids: List[str] = Field(default_factory=list)
    capability_reference_ids: List[str] = Field(default_factory=list)
    review_status: str = "not_started"
    approval_status: str = "not_requested"
    reviewer: Optional[str] = None
    review_notes: Optional[str] = None
    ...
    metadata: Dict[str, Any] = Field(default_factory=dict)
    metadata_only: bool = True
    normalisation_foundation: bool = True
    canonical_vocabulary_foundation: bool = True
...
class AirlineKnowledgeNormalisationCreate(BaseModel):
    model_config = ConfigDict(use_enum_values=True, extra="forbid")

    id: Optional[str] = None
    agency_id: Optional[str] = None
    normalisation_reference: Optional[str] = None
    normalisation_status: str = "draft"
    normalisation_type: Optional[str] = None
    canonical_code: Optional[str] = None
    canonical_name: Optional[str] = None
...
class AirlineKnowledgeNormalisationUpdate(BaseModel):
    model_config = ConfigDict(use_enum_values=True, extra="forbid")

    agency_id: Optional[str] = None
    normalisation_reference: Optional[str] = None
    normalisation_status: Optional[str] = None
    normalisation_type: Optional[str] = None
    canonical_code: Optional[str] = None
    canonical_name: Optional[str] = None
    canonical_description: Optional[str] = None
    ...
    airline_specific_terms: Optional[List[str]] = None
    gds_terms: Optional[List[str]] = None
    commercial_terms: Optional[List[str]] = None
    operational_terms: Optional[List[str]] = None
    airline_codes: Optional[List[str]] = None
    country_codes: Optional[List[str]] = None
    airport_codes: Optional[List[str]] = None
    aircraft_types: Optional[List[str]] = None
    cabin_codes: Optional[List[str]] = None
    service_codes: Optional[List[str]] = None
    ssr_codes: Optional[List[str]] = None
    rfic_codes: Optional[List[str]] = None
    rfisc_codes: Optional[List[str]] = None
    species: Optional[str] = None
    breed: Optional[str] = None
    breed_group: Optional[str] = None
    brachycephalic_flag: Optional[bool] = None
    restricted_breed_flag: Optional[bool] = None
    service_animal_flag: Optional[bool] = None
    emotional_support_animal_flag: Optional[bool] = None
    animal_notes: Optional[str] = None
    aircraft_family: Optional[str] = None
    aircraft_subtype: Optional[str] = None
    cabin_family: Optional[str] = None
    cabin_name: Optional[str] = None
    seat_type: Optional[str] = None
    fixed_armrest_flag: Optional[bool] = None
    adjacent_seat_relevance: Optional[str] = None
    under_seat_space_relevance: Optional[str] = None
    cabin_notes: Optional[str] = None
    passenger_need_category: Optional[str] = None
    ...
    unit_type: Optional[str] = None
    canonical_unit: Optional[str] = None
    unit_aliases: Optional[List[str]] = None
    conversion_notes: Optional[str] = None
    acquisition_ids: Optional[List[str]] = None
    constraint_ids: Optional[List[str]] = None
    evidence_reference_ids: Optional[List[str]] = None
    policy_reference_ids: Optional[List[str]] = None
    pricing_reference_ids: Optional[List[str]] = None
    capability_reference_ids: Optional[List[str]] = None
    review_status: Optional[str] = None
    approval_status: Optional[str] = None
    reviewer: Optional[str] = None
    review_notes: Optional[str] = None
...
class AirlineCapabilityMatrixRecord(BaseDocument):
    agency_id: Optional[str] = None
    capability_reference: str
    capability_status: str = "draft"
    ...
    rfic: Optional[str] = None
    rfisc: Optional[str] = None
    emd_relevance: Optional[str] = None
    document_relevance: Optional[str] = None
    capability_type: Optional[str] = None
    capability_status_value: Optional[str] = None
    capability_outcome: Optional[str] = None
    capability_reason: Optional[str] = None
    capability_confidence: Optional[str] = None
    capability_source_type: Optional[str] = None
    capability_review_status: str = "not_started"
    operational_validity_status: Optional[str] = None
    operational_validity_confidence: Optional[str] = None
    aircraft_applicability: List[str] = Field(default_factory=list)
    aircraft_family: Optional[str] = None
    aircraft_subtype: Optional[str] = None
    aircraft_configuration: Optional[str] = None
    cabin_applicability: List[str] = Field(default_factory=list)
    cabin_family: Optional[str] = None
    cabin_name: Optional[str] = None
    seat_type: Optional[str] = None
    seat_map_relevance: Optional[str] = None
    adjacent_seat_available: Optional[bool] = None
    adjacent_seat_required: Optional[bool] = None
    fixed_armrests: Optional[bool] = None
    movable_armrests: Optional[bool] = None
    bulkhead_restriction: Optional[str] = None
    exit_row_restriction: Optional[str] = None
    under_seat_space_available: Optional[bool] = None
    under_seat_space_notes: Optional[str] = None
    accessible_lavatory_available: Optional[bool] = None
    onboard_wheelchair_capability: Optional[str] = None
    cabin_notes: Optional[str] = None
    airport_applicability: List[str] = Field(default_factory=list)
    station_applicability: List[str] = Field(default_factory=list)
    origin_airport_applicability: List[str] = Field(default_factory=list)
    destination_airport_applicability: List[str] = Field(default_factory=list)
    transit_airport_applicability: List[str] = Field(default_factory=list)
    ground_handling_capability: Optional[str] = None
    airport_handling_required: Optional[bool] = None
    station_notification_required: Optional[bool] = None
    airport_restriction_notes: Optional[str] = None
    route_applicability: List[str] = Field(default_factory=list)
    origin_country_applicability: List[str] = Field(default_factory=list)
    destination_country_applicability: List[str] = Field(default_factory=list)
    transit_country_applicability: List[str] = Field(default_factory=list)
    seasonal_applicability: List[str] = Field(default_factory=list)
    date_range_applicability: List[Dict[str, Any]] = Field(default_factory=list)
    event_based_applicability: List[str] = Field(default_factory=list)
    embargo_applicability: List[str] = Field(default_factory=list)
    weather_temperature_relevance: Optional[str] = None
    interline_allowed: Optional[bool] = None
    codeshare_allowed: Optional[bool] = None
    operating_carrier_control_required: Optional[bool] = None
    validating_carrier_control_required: Optional[bool] = None
    marketing_carrier_restriction_notes: Optional[str] = None
    animal_transport_applicable: Optional[bool] = None
    petc_capability: Optional[str] = None
    avih_capability: Optional[str] = None
    species_applicability: List[str] = Field(default_factory=list)
    breed_applicability: List[str] = Field(default_factory=list)
    brachycephalic_capability: Optional[str] = None
    carrier_dimension_capability: Optional[str] = None
    carrier_weight_capability: Optional[str] = None
    pet_under_seat_capability: Optional[str] = None
    pet_on_adjacent_extra_seat_capability: Optional[str] = None
    animal_transport_notes: Optional[str] = None
    extra_seat_applicable: Optional[bool] = None
    extra_seat_available: Optional[bool] = None
    extra_seat_reason: Optional[str] = None
    passenger_of_size_capability: Optional[str] = None
    comfort_extra_seat_capability: Optional[str] = None
    cbbg_capability: Optional[str] = None
    musical_instrument_extra_seat_capability: Optional[str] = None
    medical_extra_seat_capability: Optional[str] = None
    adjacent_extra_seat_capability: Optional[str] = None
    extra_seat_cabin_restriction_notes: Optional[str] = None
    extra_seat_refund_capability_notes: Optional[str] = None
    wheelchair_capability: Optional[str] = None
    wchr_capability: Optional[str] = None
    wchs_capability: Optional[str] = None
    wchc_capability: Optional[str] = None
    medif_capability: Optional[str] = None
    oxygen_capability: Optional[str] = None
    stretcher_capability: Optional[str] = None
    medical_equipment_capability: Optional[str] = None
    reduced_mobility_notes: Optional[str] = None
    approval_required: Optional[bool] = None
    document_required: Optional[bool] = None
    emd_required: Optional[bool] = None
    ssr_required: Optional[bool] = None
    osi_required: Optional[bool] = None
    medif_required: Optional[bool] = None
    advance_notice_required: Optional[bool] = None
    advance_notice_hours: Optional[int] = None
    crew_notification_required: Optional[bool] = None
    operational_procedure_required: Optional[bool] = None
    manual_review_required: Optional[bool] = None
    operational_risk_level: Optional[str] = None
    operational_risk_reason: Optional[str] = None
    data_confidence_level: Optional[str] = None
    evidence_confidence_level: Optional[str] = None
    last_operational_confirmation_date: Optional[datetime] = None
    operational_confirmation_source: Optional[str] = None
    effective_from: Optional[datetime] = None
    effective_until: Optional[datetime] = None
    superseded_by_capability_id: Optional[str] = None
    supersedes_capability_ids: List[str] = Field(default_factory=list)
    archived_at: Optional[datetime] = None
    operational_notes: Optional[str] = None
    internal_notes: Optional[str] = None
    updated_by: Optional[str] = None
    ...
    metadata: Dict[str, Any] = Field(default_factory=dict)
    metadata_only: bool = True
    capability_matrix_foundation: bool = True
    live_rule_evaluation_disabled: bool = True
    passenger_feasibility_scoring_disabled: bool = True
    airline_recommendation_ranking_disabled: bool = True
    ai_reasoning_disabled: bool = True
    parser_execution_disabled: bool = True
    pricing_calculation_disabled: bool = True
    provider_integrations_disabled: bool = True
...
class AirlineCapabilityMatrixCreate(BaseModel):
    model_config = ConfigDict(use_enum_values=True, extra="forbid")
...
class AirlineCapabilityMatrixUpdate(BaseModel):
    model_config = ConfigDict(use_enum_values=True, extra="forbid")
    ...
    capability_confidence: Optional[str] = None
    capability_source_type: Optional[str] = None
    capability_review_status: Optional[str] = None
    operational_validity_status: Optional[str] = None
    operational_validity_confidence: Optional[str] = None
    aircraft_applicability: Optional[List[str]] = None
    aircraft_family: Optional[str] = None
    ...
    cabin_notes: Optional[str] = None
    airport_applicability: Optional[List[str]] = None
    station_applicability: Optional[List[str]] = None
    origin_airport_applicability: Optional[List[str]] = None
    destination_airport_applicability: Optional[List[str]] = None
    transit_airport_applicability: Optional[List[str]] = None
    ground_handling_capability: Optional[str] = None
    airport_handling_required: Optional[bool] = None
    station_notification_required: Optional[bool] = None
    airport_restriction_notes: Optional[str] = None
    ...
    origin_country_applicability: Optional[List[str]] = None
    destination_country_applicability: Optional[List[str]] = None
    transit_country_applicability: Optional[List[str]] = None
    seasonal_applicability: Optional[List[str]] = None
    date_range_applicability: Optional[List[Dict[str, Any]]] = None
    event_based_applicability: Optional[List[str]] = None
    embargo_applicability: Optional[List[str]] = None
    weather_temperature_relevance: Optional[str] = None
    interline_allowed: Optional[bool] = None
    codeshare_allowed: Optional[bool] = None
    operating_carrier_control_required: Optional[bool] = None
    ...
    effective_until: Optional[datetime] = None
    superseded_by_capability_id: Optional[str] = None
    supersedes_capability_ids: Optional[List[str]] = None
    archived_at: Optional[datetime] = None
    operational_notes: Optional[str] = None
    internal_notes: Optional[str] = None
    metadata: Optional[Dict[str, Any]] = None
...
class PassengerServiceFeasibility(BaseDocument):
    agency_id: Optional[str] = None
    feasibility_reference: str
    feasibility_status: str = "draft"
    feasibility_type: Optional[str] = None
    feasibility_version: Optional[str] = None
    created_by: Optional[str] = None
    passenger_workspace_id: Optional[str] = None
    passenger_profile_reference: Optional[str] = None
    passenger_need_summary: Optional[str] = None
    ...
    feasibility_confidence: Optional[str] = None
    feasibility_summary: Optional[str] = None
    feasibility_reason: Optional[str] = None
    feasibility_blocking_reasons: List[str] = Field(default_factory=list)
    feasibility_warning_reasons: List[str] = Field(default_factory=list)
    feasibility_conditions: List[str] = Field(default_factory=list)
    satisfied_requirements: List[str] = Field(default_factory=list)
    conditionally_satisfied_requirements: List[str] = Field(default_factory=list)
    ...
    required_crew_notification: bool = False
    required_manual_review: bool = False
    required_follow_up_tasks: List[str] = Field(default_factory=list)
    operational_risk_level: Optional[str] = None
    operational_risk_summary: Optional[str] = None
    operational_risk_reasons: List[str] = Field(default_factory=list)
    adm_risk_relevance: Optional[str] = None
    disruption_risk_relevance: Optional[str] = None
    service_failure_risk_relevance: Optional[str] = None
    evidence_trace: List[Dict[str, Any]] = Field(default_factory=list)
    evaluation_trace: List[Dict[str, Any]] = Field(default_factory=list)
    decision_trace: List[Dict[str, Any]] = Field(default_factory=list)
    data_confidence_level: Optional[str] = None
    evidence_confidence_level: Optional[str] = None
    operational_validation_confidence: Optional[str] = None
    ...
    metadata: Dict[str, Any] = Field(default_factory=dict)
    metadata_only: bool = True
    passenger_service_feasibility_foundation: bool = True
    feasibility_is_not_boolean: bool = True
    explainable_feasibility: bool = True
    evidence_linked: bool = True
    advisory_only: bool = True
    human_authority_final: bool = True
    consumes_operational_evaluation_results: bool = True
    no_ai_reasoning: bool = True
    no_llm_prompts: bool = True
    flight_search_disabled: bool = True
    airline_recommendation_ranking_disabled: bool = True
    ...
    pricing_optimisation_disabled: bool = True
    background_workers_disabled: bool = True
    automatic_operational_decisions_disabled: bool = True


class PassengerServiceFeasibilityCreate(BaseModel):
    model_config = ConfigDict(use_enum_values=True, extra="forbid")

    id: Optional[str] = None
    agency_id: Optional[str] = None
    feasibility_reference: Optional[str] = None
    feasibility_status: str = "draft"
    feasibility_type: Optional[str] = None
    feasibility_version: Optional[str] = None
    passenger_workspace_id: Optional[str] = None
...
class PassengerServiceFeasibilityUpdate(BaseModel):
    model_config = ConfigDict(use_enum_values=True, extra="forbid")
    ...
    origin: Optional[str] = None
    destination: Optional[str] = None
    transit_points: Optional[List[str]] = None
    travel_date: Optional[str] = None
    cabin_requested: Optional[str] = None
    airline_code: Optional[str] = None
    airline_name: Optional[str] = None
    ...
    feasibility_summary: Optional[str] = None
    feasibility_reason: Optional[str] = None
    feasibility_blocking_reasons: Optional[List[str]] = None
    feasibility_warning_reasons: Optional[List[str]] = None
    feasibility_conditions: Optional[List[str]] = None
    satisfied_requirements: Optional[List[str]] = None
    conditionally_satisfied_requirements: Optional[List[str]] = None
    unsatisfied_requirements: Optional[List[str]] = None
    unknown_requirements: Optional[List[str]] = None
    required_ssrs: Optional[List[str]] = None
    required_osis: Optional[List[str]] = None
    required_emds: Optional[List[str]] = None
    required_documents: Optional[List[str]] = None
    ...
    required_crew_notification: Optional[bool] = None
    required_manual_review: Optional[bool] = None
    required_follow_up_tasks: Optional[List[str]] = None
    operational_risk_level: Optional[str] = None
    operational_risk_summary: Optional[str] = None
    operational_risk_reasons: Optional[List[str]] = None
    adm_risk_relevance: Optional[str] = None
    disruption_risk_relevance: Optional[str] = None
    service_failure_risk_relevance: Optional[str] = None
    evidence_trace: Optional[List[Dict[str, Any]]] = None
...
class IntelligentOfferBuilderPackage(BaseDocument):
    agency_id: Optional[str] = None
    offer_intelligence_reference: str
    ...
    offer_workspace_id: Optional[str] = None
    offer_reference: Optional[str] = None
    offer_option_ids: List[str] = Field(default_factory=list)
    offer_status: Optional[str] = None
    client_visibility_status: Optional[str] = None
    recommendation_ids: List[str] = Field(default_factory=list)
    feasibility_ids: List[str] = Field(default_factory=list)
    operational_evaluation_ids: List[str] = Field(default_factory=list)
    capability_matrix_ids: List[str] = Field(default_factory=list)
    ...
    recommended_itineraries: List[str] = Field(default_factory=list)
    recommendation_rankings: List[Dict[str, Any]] = Field(default_factory=list)
    recommendation_scores: List[Dict[str, Any]] = Field(default_factory=list)
    recommendation_levels: List[str] = Field(default_factory=list)
    recommendation_reasons: List[str] = Field(default_factory=list)
    readiness_status: Optional[str] = None
    readiness_summary: Optional[str] = None
    readiness_blockers: List[str] = Field(default_factory=list)
    readiness_warnings: List[str] = Field(default_factory=list)
    readiness_conditions: List[str] = Field(default_factory=list)
    operational_risk_level: Optional[str] = None
    required_ssrs: List[str] = Field(default_factory=list)
    required_osis: List[str] = Field(default_factory=list)
    required_emds: List[str] = Field(default_factory=list)
    ...
    total_cost_reference: Optional[str] = None
    pricing_notes: Optional[str] = None
    refund_condition_references: List[str] = Field(default_factory=list)
    exchange_condition_references: List[str] = Field(default_factory=list)
    client_explanation_summary: Optional[str] = None
    client_visible_reasons: List[str] = Field(default_factory=list)
    client_visible_limitations: List[str] = Field(default_factory=list)
    client_visible_conditions: List[str] = Field(default_factory=list)
    client_visible_documents: List[str] = Field(default_factory=list)
    client_visible_price_notes: List[str] = Field(default_factory=list)
    internal_operational_reasoning: Optional[str] = None
    internal_risk_notes: Optional[str] = None
    internal_evidence_trace: List[Dict[str, Any]] = Field(default_factory=list)
    internal_decision_trace: List[Dict[str, Any]] = Field(default_factory=list)
    decision_pack_ready: bool = False
    decision_pack_reference: Optional[str] = None
    decision_pack_summary: Optional[str] = None
    decision_pack_sections: List[Dict[str, Any]] = Field(default_factory=list)
    decision_pack_evidence: List[Dict[str, Any]] = Field(default_factory=list)
    prepared_for_offer_builder: bool = False
    reviewed_by_agent: bool = False
    approved_for_client_presentation: bool = False
    archived: bool = False
    archived_at: Optional[datetime] = None
    internal_notes: Optional[str] = None
    agent_notes: Optional[str] = None
    metadata: Dict[str, Any] = Field(default_factory=dict)
    metadata_only: bool = True
    intelligent_offer_builder_integration_foundation: bool = True
    offer_builder_should_not_invent_intelligence: bool = True
    consumes_passenger_service_feasibility: bool = True
    consumes_airline_recommendations: bool = True
...
class IntelligentOfferBuilderPackageCreate(BaseModel):
    model_config = ConfigDict(use_enum_values=True, extra="forbid")

    id: Optional[str] = None
    agency_id: Optional[str] = None
    offer_intelligence_reference: Optional[str] = None
    package_status: str = "draft"
    package_version: Optional[str] = None
    passenger_workspace_id: Optional[str] = None
    passenger_profile_reference: Optional[str] = None
...
class IntelligentOfferBuilderPackageUpdate(BaseModel):
    model_config = ConfigDict(use_enum_values=True, extra="forbid")
    ...
    offer_workspace_id: Optional[str] = None
    offer_reference: Optional[str] = None
    offer_option_ids: Optional[List[str]] = None
    offer_status: Optional[str] = None
    client_visibility_status: Optional[str] = None
    recommendation_ids: Optional[List[str]] = None
    feasibility_ids: Optional[List[str]] = None
    ...
    recommended_itineraries: Optional[List[str]] = None
    recommendation_rankings: Optional[List[Dict[str, Any]]] = None
    recommendation_scores: Optional[List[Dict[str, Any]]] = None
    ...
    readiness_blockers: Optional[List[str]] = None
    readiness_warnings: Optional[List[str]] = None
    readiness_conditions: Optional[List[str]] = None
    operational_risk_level: Optional[str] = None
    required_ssrs: Optional[List[str]] = None
    required_osis: Optional[List[str]] = None
    required_emds: Optional[List[str]] = None
    ...
    total_cost_reference: Optional[str] = None
    pricing_notes: Optional[str] = None
    refund_condition_references: Optional[List[str]] = None
    exchange_condition_references: Optional[List[str]] = None
    client_explanation_summary: Optional[str] = None
    client_visible_reasons: Optional[List[str]] = None
    client_visible_limitations: Optional[List[str]] = None
    client_visible_conditions: Optional[List[str]] = None
    client_visible_documents: Optional[List[str]] = None
    client_visible_price_notes: Optional[List[str]] = None
    internal_operational_reasoning: Optional[str] = None
    internal_risk_notes: Optional[str] = None
    internal_evidence_trace: Optional[List[Dict[str, Any]]] = None
    internal_decision_trace: Optional[List[Dict[str, Any]]] = None
    decision_pack_ready: Optional[bool] = None
    decision_pack_reference: Optional[str] = None
    decision_pack_summary: Optional[str] = None
    decision_pack_sections: Optional[List[Dict[str, Any]]] = None
    decision_pack_evidence: Optional[List[Dict[str, Any]]] = None
    prepared_for_offer_builder: Optional[bool] = None
    reviewed_by_agent: Optional[bool] = None
    approved_for_client_presentation: Optional[bool] = None
    archived: Optional[bool] = None
    archived_at: Optional[datetime] = None
    internal_notes: Optional[str] = None
    agent_notes: Optional[str] = None
