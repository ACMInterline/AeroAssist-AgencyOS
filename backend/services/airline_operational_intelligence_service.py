...
class AirlineOperationalIntelligenceService:
    ...
    def sections_from_architecture(self, architecture: dict[str, Any]) -> list[dict[str, Any]]:
        return [
            ...
            {"key": "airline_itinerary_recommendation", "label": "Airline-Itinerary Recommendation", "body": "Phase 50.8 records advisory airline and itinerary recommendation metadata from Passenger Service Feasibility. Recommendation is not feasibility, not booking, not search, and human authority remains final."},
