...
COLLECTION_OWNERSHIP_REGISTRY: dict[str, CollectionOwnership] = {
    ...
    for item in (
        ...
        _agency("trip_accepted_offer_snapshots", filters=("trip_id", "acceptance_id", "offer_id"), sorts=("trip_id",), ownership=CollectionOwnershipType.IMMUTABLE_SNAPSHOT, historical_reads=True),
        ...
        _agency("invoices", filters=("trip_id", "booking_id", "client_id", "status", "invoice_status"), sorts=("status", "invoice_status", "due_date")),
        ...
        _agency("offer_acceptances", filters=("trip_id", "offer_id", "status"), sorts=("status",), ownership=CollectionOwnershipType.IMMUTABLE_SNAPSHOT, historical_reads=True),
