...
This repository currently contains the Phase 0 architecture specifications through Phase 36.8 canonical service taxonomy foundation, including CRM, requests, trips, reference/service catalogue governance, rules/services, offer builder, offer acceptance/booking readiness, booking/ticket/EMD mirrors, standalone/import/change/exchange workflows, document foundation, governed GDS parser foundation, governed airline policy source/extraction/review foundations, and canonical special/ancillary service taxonomy mapping.
...
- Airline scraping, external AI policy extraction or taxonomy mapping, automated policy evaluation, automatic global policy/taxonomy promotion, SSR/OSI/EMD/payment execution, policy comparison matrix, and automated pricing.
