...
export const agencyModuleGroups = [
  {
    ...
    items: [
      ...
      { label: "Operations Command Centre", description: "Compatibility route for the agency operations home", href: "/agency/operations-command-center", icon: "rows", badge: "Contextual", entitlementKey: "operations_command_center", metadata_only: true, navigation_visibility: "contextual" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Operations Command Centre", description: "Compatibility route for operational workload", href: "/agency/operations-command-center", icon: "rows", badge: "Contextual", entitlementKey: "operations_command_center", metadata_only: true, navigation_visibility: "contextual" },
...
const agencyProductAreaDefinitions = [
  ...
  },
  {
    ...
    icon: "clipboard",
    allowed_roles: ["agency_owner", "agency_admin", "agency_accountant", "agency_agent", "agency_readonly"],
    items: [
      { href: "/agency/finance", preferred_label: "Finance & reports", preferred_description: "Review revenue, costs, margin, balances, refunds, and exchanges" },
      { href: "/agency/invoices", preferred_label: "Invoices", preferred_description: "Review invoice and payment status" },
      { href: "/agency/supplier-costs", preferred_label: "Supplier costs", preferred_description: "Review agency-private cost records", allowed_roles: ["agency_owner", "agency_admin", "agency_accountant"], required_permission: "view_supplier_costs" },
    ],
  },
  {
    title: "Settings",
