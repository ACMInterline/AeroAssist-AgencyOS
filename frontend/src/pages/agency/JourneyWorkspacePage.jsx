...
function JourneyDetail({ detail, presentation, setPresentation, onSavePresentation, onCreateSnapshot, onError }) {
  ...
  return <main className="min-w-0 space-y-7">
    <section className="border-b border-slate-200 pb-5">
      ...
      <a href={`/agency/journey-authoring?journey_id=${encodeURIComponent(journey.id)}`} className="mt-4 inline-flex items-center gap-2 rounded-md border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-slate-800"><Plane className="h-4 w-4" />Edit Journey segments</a>
