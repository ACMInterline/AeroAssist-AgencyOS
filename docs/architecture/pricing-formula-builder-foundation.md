...
Phase 52.7 adds Airline Knowledge Publishing as controlled publication workflow metadata. Knowledge Publishing can include pricing formula references, QA review links, release channels, consumer readiness, and agency visibility metadata, but it does not calculate prices, publish automatically, execute recommendations, call providers, use AI, run workers, or replace human authority.
