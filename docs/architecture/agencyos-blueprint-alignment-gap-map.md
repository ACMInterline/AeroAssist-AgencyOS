...
| Offers/comparison | Partial legacy/foundation | offer models/routes | Needs modern comparison matrix and trip attachment rules | Future phase | High | Offers may exist before trip but accepted offers should attach early. Phase 36.0 only prepares rules/services checks. |
...
| Airline policies | Phase 36.0 shared rules/services foundation | `AirlineRulesCore`, `UnifiedExceptionRule`, `PassengerServiceRequest`, airline intelligence foundation models, platform/agency rules-services routers | Needs versioned import workflow, richer source governance, offer feasibility integration, and broader UI depth | Future phase | High | Platform owns global rules; agencies consume/evaluate in operational flows. Service catalogue remains separate from airline-specific acceptance decisions. |
