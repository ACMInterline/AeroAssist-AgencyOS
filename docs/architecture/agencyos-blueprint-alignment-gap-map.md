...
| Reference data | Phase 33 core plus Phase 33.1 governance | `global_reference_records`, `service_catalogue`, `reference_data_suggestions`, `reference_import_batches`, reference router | Agency local override UI remains future work | Phase 34+ | Medium | Global records are platform-owned; agencies suggest changes through review instead of creating master data directly. |
