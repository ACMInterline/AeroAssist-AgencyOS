...
| Reference data | Phase 33 reference data core and service catalogue | `global_reference_records`, `service_catalogue`, reference router | Agency override UI and deeper request-builder consumption remain future work | Phase 34+ | Medium | Service catalogue now drives shared codes, SSR defaults, scoping/check flags, and schemas. |
