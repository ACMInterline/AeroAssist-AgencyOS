...
No redirects or aliases are added in Phase 36.4.5, Phase 36.4.6, Phase 36.5, or Phase 36.6. Documentation and API/UI mapping are preferred so future work remains explicit.
