...
No redirects or aliases are added in Phase 36.4.5, Phase 36.4.6, Phase 36.5, Phase 36.6, Phase 36.7, Phase 36.8, or Phase 36.9. Documentation and API/UI mapping are preferred so future work remains explicit.
